...
type AgentInfo struct {
	...
	// DiskUsage is Edgelet data-directory usage in GiB, not host filesystem totals.
	...
	SystemTotalMemory     int64   `json:"systemTotalMemory" yaml:"systemTotalMemory"`
	SystemAvailableMemory int64   `json:"systemAvailableMemory" yaml:"systemAvailableMemory"`
	SystemTotalDisk       int64   `json:"systemTotalDisk" yaml:"systemTotalDisk"`
	SystemAvailableDisk   int64   `json:"systemAvailableDisk" yaml:"systemAvailableDisk"`
	// SystemTotalCPU is host CPU busy percentage 0–100, not logical core count (see SystemCpus).
	...
	// SystemKernelVersion is the Linux kernel release; empty on non-Linux hosts.
